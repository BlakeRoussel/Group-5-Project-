...
-------------------------------------
###Research Question
What state is a graduate most likey to live in based on the major they graduated with? e.g. What majors are higest demand in each state?
...
Of the graduates that stayed in Louisiana, most reside in Baton Rouge with New Orleans hosuing the second most.
